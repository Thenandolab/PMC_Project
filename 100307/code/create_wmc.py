...
files = glob.glob("/Users/nando/Desktop/HCP/subjects/100307/TOM_trackings" + "/*.tck")
...
for file in files:
    ...
    with open ('/Users/nando/Desktop/HCP/subjects/100307/TOM_trackings/wmc/tracts'+str(len(names))+'.json', 'w') as outfile:
...
with open ('/Users/nando/Desktop/HCP/subjects/100307/TOM_trackings/wmc/tractstracts.json', 'w') as outfile:
    json.dump(tractsfile, outfile, separators=(',', ': '), indent=4)

print("saving classification.mat")
sio.savemat('/Users/nando/Desktop/HCP/subjects/100307/TOM_trackings/wmc/classification.mat', { "classification": {"names": names, "index": fiber_index }})

print("creating track.tck")
commands = ["tckedit", "-force"] + files + ["/Users/nando/Desktop/HCP/subjects/100307/track.tck"]
print(commands)
